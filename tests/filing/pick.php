...
f_check( '42i the pill on a trail row: agree is sure whatever the score, ok by the model alone is likely whatever the score, ok by the rules as before', 'sure' === vergeml_filing_confidence( 1, array( 'why' => 'agree', 'score' => 0.61 ) ) && 'likely' === vergeml_filing_confidence( 1, array( 'why' => 'ok', 'score' => 0.9, 'source' => 'model' ) ) && 'sure' === vergeml_filing_confidence( 1, array( 'why' => 'ok', 'score' => 0.9, 'source' => 'name' ) ) && '' === vergeml_filing_confidence( 1, array( 'why' => 'doubt', 'score' => 0.9 ) ), sprintf( '%s %s %s "%s"', vergeml_filing_confidence( 1, array( 'why' => 'agree', 'score' => 0.61 ) ), vergeml_filing_confidence( 1, array( 'why' => 'ok', 'score' => 0.9, 'source' => 'model' ) ), vergeml_filing_confidence( 1, array( 'why' => 'ok', 'score' => 0.9, 'source' => 'name' ) ), vergeml_filing_confidence( 1, array( 'why' => 'doubt', 'score' => 0.9 ) ) ) );
