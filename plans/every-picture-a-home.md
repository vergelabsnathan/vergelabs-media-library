...
- **S14** — the member profile trusts only sure and hand placements (judged on the S13 sheet); the two pre-S13 UI reds; S10.5b the foreign tree (HEMA's, written; 0 credits; Nathan's yes first); the shop band on its marks; then S10.8 as below.
