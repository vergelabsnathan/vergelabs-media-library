...
- Only the Pro plugin asks this channel. `pro/includes/updates.php` asks
  ...
  two "previous" versions agree; after 4.0.6 (2026-09-25) the catalogue's
  previous is 4.0.5 and GitHub's is v4.0.5. (Before 4.0.1 they differed: the
...
from then the free file waits a day as well). On the shelf (2026-09-25,
after the 4.0.6 train): free `…-3.16.1-b787a3bb6a20.zip`,
`…-3.16.1-7f2a4fe9bee9.zip`, `…-4.0.0-bf0d63b70056.zip`,
`…-4.0.1-c5510da6b16a.zip`, `…-4.0.2-d57c3020567e.zip`,
`…-4.0.3-95ec481210d9.zip`, `…-4.0.4-3829283bb85a.zip`,
`…-4.0.5-0b8e20c4856b.zip` and `…-4.0.6-7b2efd20fe78.zip`; Pro
`…-1.0.1-d0fe7f2ee9.zip`, `…-1.0.2-2a6a794642.zip` and
`…-1.0.3-9bb6c8ff5088.zip`. The catalogue serves 4.0.6 and 1.0.3; a
rollback of either is one row back to 4.0.5 / 1.0.2. Nothing has been
...
2026-09-22 (service `9664331`; env swap 7 s, redeploy 50 s); 4.0.4 on
2026-09-22 (service `e09013d`; env swap 8 s, redeploy 46 s); 4.0.5 on
2026-09-24 (service `1b2d14a`; env swap 12 s, redeploy 45 s); 4.0.6 on
2026-09-25 (service `ec78e15`; redeploy 45 s). One thing
