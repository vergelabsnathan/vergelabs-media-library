...
**`dist/vergelabs-media-library-4.0.7.zip`** — built 2026-09-25 from `23faaee`,
tagged `v4.0.7`. 145 entries (`changelog.txt` added), 1,111,084 bytes, sha256 begins `0df5d200c51e`
(4.0.6 was `dab340f`, 144 entries, `7b2efd20fe78`; 4.0.5 was `dfea3c5`, 144 entries, `0b8e20c4856b`; 4.0.4 was `7563c0a`, 143 entries, `3829283bb85a`; 4.0.3 was `82bd06d`, 143 entries, `95ec481210d9`; 4.0.2 was `0e03cd4`, 143 entries, `d57c3020567e`; 4.0.1 was `b6a89f1`, 143 entries, `c5510da6b16a`; 4.0.0 was `59df217`, 145
...
plugin file present, and `Stable tag: 4.0.7` and `Version: 4.0.7` read back out
